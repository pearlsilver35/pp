...
$query_visitors = "SELECT * FROM vistor_info";
$visitors = mysql_query($query_visitors, $pp) or die(mysql_error());
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                visitors
               			 <small>Information of visitors that visited your site and the number of times they visited</small>
                            </h2>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
                                        <?php do { ?>
                                    <tr>
                                      <td><?php echo $row_visitors['ip_address']; ?></td>
                                      <td><?php echo $row_visitors['referer']; ?></td>
                                      <td><?php echo $row_visitors['date']; ?></td>
                                      <td><?php echo $row_visitors['counter']; ?></td>
