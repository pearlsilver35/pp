...
$messages = mysql_query($query_messages, $pp) or die(mysql_error());
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                Messages
               			 <small>Left by vistors trying to contact you on your site, click there names to view</small>
                            </h2>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
                                        <?php do { ?>
                                    <tr>
                                      <td><a data-toggle="modal" data-target="#message<?php echo $row_messages['id']; ?>"><?php echo $row_messages['Name']; ?></a></td>
                                      <td><?php echo $row_messages['Email']; ?></td>
                                      <td><?php echo $row_messages['Time']; ?></td>
                                      
<div class="modal fade" id="message<?php echo $row_messages['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
      <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel"><?php echo $row_messages['Name']; ?> Message</h5>
